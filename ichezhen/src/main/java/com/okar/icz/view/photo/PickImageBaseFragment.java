...
public abstract class PickImageBaseFragment extends BaseFragment {
    ...
    protected void pickImageFromCamera() {
        takePicture = PhotoUtils.takePicture(getActivity());
    }
        ...
        switch (requestCode) {
            case PhotoUtils.INTENT_REQUEST_CODE_ALBUM:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (isDispose) {
                        corpPhotoResultUri = PhotoUtils.cropPhoto(getActivity(), path);
                    } else {
